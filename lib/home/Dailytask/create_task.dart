  ...
  Future<void> _submitTask() async {
    if (_taskController.text.trim().isNotEmpty && selectedDate != null && selectedTime != null) {
      ...
      if (result["success"] == true) {
        ...
        appSnackbar("Success", result["message"] ?? "Task created successfully");
        if (mounted) {
        ...
        return Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              20.verticalSpace,
              const Text("Create a Task", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              20.verticalSpace,
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _taskController.text.trim().isNotEmpty && selectedDate != null && selectedTime != null
                      ? const Color(0xFF3C3129)
                      : Colors.grey.shade400,
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                  minimumSize: const Size(double.infinity, 50),
                ),
                child: const Text("Create a Task", style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
        );
