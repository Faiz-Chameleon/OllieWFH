                    ...
                    Obx(
                      () => DropdownButtonFormField2<String>(
                        ...
                        decoration: customInputDecoration(
                          labelText: "",
                        ).copyWith(contentPadding: const EdgeInsets.symmetric(horizontal: 30, vertical: 15)),
                        hint: Text(
                          'Select Gender',
                          ...
                          child: InputDecorator(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 16.sp, color: controller.selectedDate.value == null ? Colors.grey : Colors.Black),
                              ),
                            ),
                          ),
                        ),
