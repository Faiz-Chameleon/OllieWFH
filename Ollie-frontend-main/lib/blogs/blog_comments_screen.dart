  ...
  Widget _buildCommentItem(
    ...
    return Container(
      margin: EdgeInsets.only(
        left: isMainComment ? 0 : 32,
        top: isMainComment ? 0 : 8,
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        if (isMainComment) {
                          ...
                          await controller.toggleReplyLike(
                            comment,
                            parentComment!.id,
                          );
                        }
                  ...
                  child: Container(
                    ...
                    child: Obx(
                      () => TextField(
                        ...
                        enabled:
                            controller.mainCommentStatus.value !=
                  ...
                  () => GestureDetector(
                    onTap:
                        controller.mainCommentStatus.value ==
                            RequestStatus.loading
                        ? null
                        : () => controller.submitMessage(widget.blogId),
                    child: Container(
                      width: 36,
                      height: 36,
                      decoration: BoxDecoration(
